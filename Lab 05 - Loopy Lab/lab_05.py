...
def draw_section_6():
    for column in range(30):
        for row in range(column):
            x = 605 - column * 10.35  # Instead of zero, calculate the proper x location using 'column'
            y = 305 + row * 10.35  # Instead of zero, calculate the proper y location using 'row'
            arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
...
def draw_section_7():
    for row in range(30):
        for column in range(row):
            x = 605 + column * 10.35  # Instead of zero, calculate the proper x location using 'column'
            y = 295 + row * 10.35  # Instead of zero, calculate the proper y location using 'row'
            arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
...
def draw_section_8():
    for row in range(30):
        for column in range(row):
            x = 1195 - column * 10.35  # Instead of zero, calculate the proper x location using 'column'
            y = 295 + row * 10.35  # Instead of zero, calculate the proper y location using 'row'
            arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
